<#
.SYNOPSIS
    Deploys the Recursive Permission Scanner flow to Power Platform.

.DESCRIPTION
    This script:
    1. Creates a new solution package with the RecursivePermissionScanner workflow
    2. Adds the workflow to the existing SharePointPermissionScanner solution
    3. Deploys the solution using PAC CLI
    4. Optionally runs a test with DryRun=true

.PARAMETER SkipDeploy
    If specified, creates the solution but doesn't deploy it.

.PARAMETER TestAfterDeploy
    If specified, runs a test after deployment.
...
$sourceWorkflow = Join-Path $solutionRoot "workflows\RecursivePermissionScanner.json"
$tempFolder = Join-Path $solutionRoot "recursive_scanner_build"
$outputZip = Join-Path $solutionRoot "RecursivePermissionScanner.zip"
...
Write-Host "|     Recursive Permission Scanner - Deployment Script         |" -ForegroundColor Cyan
Write-Host "================================================================" -ForegroundColor Cyan
Write-Host ""
...
$workflowFileName = "RecursivePermissionScanner-$workflowGuid.json"
...
<ImportExportXml version="9.2.25113.161" SolutionPackageVersion="9.2" languagecode="1033" generatedBy="CrmLive" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" OrganizationVersion="9.2.25113.161" OrganizationSchemaType="Full" CRMServerServiceabilityVersion="9.2.25113.00161">
  <SolutionManifest>
    <UniqueName>RecursivePermissionScanner</UniqueName>
    <LocalizedNames>
      <LocalizedName description="Recursive Permission Scanner" languagecode="1033" />
    </LocalizedNames>
    <Descriptions>
      <Description description="Scans SharePoint folders for broken permissions using two-step approach" languagecode="1033" />
    </Descriptions>
    <Version>1.0</Version>
    <Managed>0</Managed>
    <Publisher>
...
<ImportExportXml xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" OrganizationVersion="9.2.25113.161" OrganizationSchemaType="Full" CRMServerServiceabilityVersion="9.2.25113.00161">
  ...
  <Roles></Roles>
  <Workflows>
    <Workflow WorkflowId="$workflowGuidBraces" Name="Recursive Permission Scanner">
      ...
      <LocalizedNames>
        <LocalizedName languagecode="1033" description="Recursive Permission Scanner" />
      </LocalizedNames>
    </Workflow>
  </Workflows>
...
Write-Host "  2. Go to Solutions > Recursive Permission Scanner" -ForegroundColor Gray
...
Write-Host "     LibraryName: Documents" -ForegroundColor DarkGray
Write-Host "     BaseLibraryPath: /sites/Permission-Scanner-Test/Shared Documents" -ForegroundColor DarkGray
Write-Host "     MinimumLevel: -1" -ForegroundColor DarkGray
Write-Host "     DryRun: true" -ForegroundColor DarkGray
Write-Host ""
